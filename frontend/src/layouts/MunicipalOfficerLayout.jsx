        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {HUB_CARDS.map((card) => (
            ...
            >
              ...
              <div className="mt-5 text-xs font-bold flex items-center gap-1" style={{ color: card.accent }}>
                Open → <Activity className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </button>
          ))}
        </div>
